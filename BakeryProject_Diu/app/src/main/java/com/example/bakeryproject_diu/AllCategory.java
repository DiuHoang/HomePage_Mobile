...
import com.example.bakeryproject_diu.adapter.AllCategoryAdapter;
import com.example.bakeryproject_diu.model.AllCategoryModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent back = new Intent(com.example.bakeryproject_diu.AllCategory.this, MainActivity.class);
                startActivity(back);
                finish();
            }
        });
